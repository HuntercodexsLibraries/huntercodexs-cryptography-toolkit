...
public class CryptographyContract {
    ...
    public CryptographyContract() {
    }

    public CryptographyContract(String secretKey, String salt, String iv, CryptographySecretKeySource cryptographySecretKeySource, CryptographyIvSource cryptographyIvSource) {
